  ...
  const plans = [
    {
      ...
      price: "$40",
      url: "/guitar-lesson-packages/weekday-lessons",
    ...
    <section className="py-8 px-6 bg-white text-center">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {displayedPlans.map((plan, i) => (
          <Link href={plan.url} key={i} className="border rounded-lg p-6 shadow hover:shadow-md transition block hover:bg-gray-50">
            ...
            <p className="text-blue-500 hover:underline font-medium">View Details</p>
          </Link>
        ))}
      </div>
      <div className="mt-8">
